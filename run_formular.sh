...
DATA=/home/public/yushilin/formular/formulae/
mkdir ${LOG_DIR}
export BSZ=32
export valid_BSZ=32
#--input-size 192-768
...
CUDA_VISIBLE_DEVICES=1 python $(which fairseq-train) --data-type formular --input-size 224-672 --user-dir ./ --task text_recognition  \
